...
2.  **Build the SAM application:**
    ...
    ```bash
    sam build iprsidentityverification updloaddocument
    ```
...
2.  **Invoke a specific Lambda function:**
    ...
    ```bash
    sam local invoke IprsidentityverificationFunction -e core/functions/iprsidentityverification/test/events/event.json
    ```
...
```bash
cd core/functions/iprsidentityverification/test
