...
def deploy_feature_flags(config: Dict[str, Any], parameter_prefix: str = '/jubilee/kyc/feature-flags') -> None:
    ...
    if success_count == total_count:
        ...
        print("⚠️  Some feature flags failed to deploy. Check the errors above.")
    ...
    try:
        ...
        for param in parameters:
            ...
            try:
                ...
                print(f"   ⚠️  {param_name} - Invalid JSON structure")
...
def rollback_deployment(parameter_prefix: str = '/jubilee/kyc/feature-flags') -> None:
    ...
    print(f"⚠️  This will DELETE ALL parameters under {parameter_prefix}")
    ...
    try:
        ...
        for i in range(0, len(parameters_to_delete), batch_size):
            ...
            print(f"🗑️  Deleted batch: {[p.split('/')[-1] for p in batch]}")
