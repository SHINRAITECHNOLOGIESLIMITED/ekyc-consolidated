"""
E2E Test: Peninah National ID Validation + Face Matching
...
ID_NUMBER = "27681984"
GENDER = "Female"
DOC_S3_URL = "s3://maisha-verification-dev-686255958278/uploaded_kyc_docs/Peninah_National_ID.jpeg"
LIVENESS_S3_PATH = "liveness/Peninah_Face_Liveness_Capture.jpeg"
...
# Store the s3Path for face matching
...
# Extract IPRS verification response for face matching
...
# The face match needs:
# - sessionId: we'll use a test session ID pointing to the liveness capture
# - documentType: national_id
# - documentS3Path: the path from step 1
# - idNumber: for IPRS photo lookup
# - iprsVerificationResponse: from step 2
...
face_match_payload = {
    ...
    "data": {
        ...
        "idNumber": ID_NUMBER,
        "livenessS3Path": LIVENESS_S3_PATH,
...
print(f"  Liveness S3 Path: {LIVENESS_S3_PATH}")
